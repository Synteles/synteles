...
PROVIDERS: dict[str, dict] = {
    "anthropic": {
        ...
        "models": [
            ...
            {"id": "claude-3-haiku-20240307",      "name": "Claude 3 Haiku (deprecated — use Haiku 4.5)"},
        ],
    },
    "openai": {
        "name": "OpenAI",
        ...
        "models": [
            ...
            {"id": "gpt-4.1-mini-2025-04-14",    "name": "GPT-4.1 Mini (snapshot)",       "family": "GPT-4.1"},
            {"id": "gpt-4.1-nano",               "name": "GPT-4.1 Nano (1M ctx)",         "family": "GPT-4.1"},
            {"id": "gpt-4.1-nano-2025-04-14",    "name": "GPT-4.1 Nano (snapshot)",       "family": "GPT-4.1"},
            ...
            # ── GPT-4 Turbo (legacy) ──────────────────────────────────────────
            {"id": "gpt-4-turbo",                "name": "GPT-4 Turbo (legacy, 128K ctx)", "family": "GPT-4 Legacy"},
            {"id": "gpt-4-turbo-2024-04-09",     "name": "GPT-4 Turbo (snapshot, legacy)", "family": "GPT-4 Legacy"},
            # ── GPT-3.5 Turbo (legacy) ────────────────────────────────────────
            {"id": "gpt-3.5-turbo",              "name": "GPT-3.5 Turbo (legacy)", "family": "GPT-3.5 Legacy"},
            {"id": "gpt-3.5-turbo-0125",         "name": "GPT-3.5 Turbo (snapshot, legacy)", "family": "GPT-3.5 Legacy"},
        ],
    },
    "bedrock": {
        "name": "AWS Bedrock",
        ...
        "models": [
            ...
            {"id": "anthropic.claude-opus-4-6-v1",               "name": "Claude Opus 4.6",            "family": "Anthropic"},
            {"id": "anthropic.claude-sonnet-4-5-20250929-v1:0",  "name": "Claude Sonnet 4.5",          "family": "Anthropic"},
            {"id": "anthropic.claude-opus-4-5-20251101-v1:0",    "name": "Claude Opus 4.5",            "family": "Anthropic"},
            {"id": "anthropic.claude-sonnet-4-20250514-v1:0",    "name": "Claude Sonnet 4",            "family": "Anthropic"},
            {"id": "anthropic.claude-opus-4-1-20250805-v1:0",    "name": "Claude Opus 4.1",            "family": "Anthropic"},
            {"id": "anthropic.claude-opus-4-20250514-v1:0",      "name": "Claude Opus 4",              "family": "Anthropic"},
            {"id": "anthropic.claude-haiku-4-5-20251001-v1:0",   "name": "Claude Haiku 4.5",           "family": "Anthropic"},
            {"id": "anthropic.claude-3-5-haiku-20241022-v1:0",   "name": "Claude 3.5 Haiku",           "family": "Anthropic"},
            ...
            # ── Meta Llama (base) ─────────────────────────────────────────────
            {"id": "meta.llama4-maverick-17b-instruct-v1:0",  "name": "Llama 4 Maverick 17B",  "family": "Meta Llama"},
            {"id": "meta.llama4-scout-17b-instruct-v1:0",     "name": "Llama 4 Scout 17B",     "family": "Meta Llama"},
            {"id": "meta.llama3-3-70b-instruct-v1:0",         "name": "Llama 3.3 70B",         "family": "Meta Llama"},
            {"id": "meta.llama3-2-90b-instruct-v1:0",         "name": "Llama 3.2 90B",         "family": "Meta Llama"},
            {"id": "meta.llama3-2-11b-instruct-v1:0",         "name": "Llama 3.2 11B",         "family": "Meta Llama"},
            {"id": "meta.llama3-2-3b-instruct-v1:0",          "name": "Llama 3.2 3B",          "family": "Meta Llama"},
            {"id": "meta.llama3-2-1b-instruct-v1:0",          "name": "Llama 3.2 1B",          "family": "Meta Llama"},
            {"id": "meta.llama3-1-405b-instruct-v1:0",        "name": "Llama 3.1 405B",        "family": "Meta Llama"},
            {"id": "meta.llama3-1-70b-instruct-v1:0",         "name": "Llama 3.1 70B",         "family": "Meta Llama"},
            {"id": "meta.llama3-1-8b-instruct-v1:0",          "name": "Llama 3.1 8B",          "family": "Meta Llama"},
            ...
            # ── Mistral (base) ────────────────────────────────────────────────
            {"id": "mistral.mistral-large-3-675b-instruct",  "name": "Mistral Large 3",          "family": "Mistral"},
            {"id": "mistral.pixtral-large-2502-v1:0",        "name": "Pixtral Large 25.02",      "family": "Mistral"},
            {"id": "mistral.magistral-small-2509",           "name": "Magistral Small 25.09",    "family": "Mistral"},
            {"id": "mistral.devstral-2-123b",                "name": "Devstral 2 123B (code)",   "family": "Mistral"},
            {"id": "mistral.mistral-large-2407-v1:0",        "name": "Mistral Large 24.07",      "family": "Mistral"},
            {"id": "mistral.ministral-3-14b-instruct",       "name": "Ministral 14B",            "family": "Mistral"},
            ...
            {"id": "mistral.mixtral-8x7b-instruct-v0:1",     "name": "Mixtral 8x7B",            "family": "Mistral"},
            ...
            # ── Qwen (base) ───────────────────────────────────────────────────
            {"id": "qwen.qwen3-coder-480b-a35b-v1:0",     "name": "Qwen3 Coder 480B (code)",   "family": "Qwen"},
            {"id": "qwen.qwen3-235b-a22b-2507-v1:0",      "name": "Qwen3 235B",                "family": "Qwen"},
            {"id": "qwen.qwen3-coder-30b-a3b-v1:0",       "name": "Qwen3 Coder 30B (code)",   "family": "Qwen"},
            ...
            {"id": "global.anthropic.claude-opus-4-6-v1",               "name": "Claude Opus 4.6 [global]",    "family": "Anthropic (global)"},
            {"id": "global.anthropic.claude-opus-4-5-20251101-v1:0",    "name": "Claude Opus 4.5 [global]",    "family": "Anthropic (global)"},
            {"id": "global.anthropic.claude-sonnet-4-6",                 "name": "Claude Sonnet 4.6 [global]",  "family": "Anthropic (global)"},
            {"id": "global.anthropic.claude-sonnet-4-5-20250929-v1:0",  "name": "Claude Sonnet 4.5 [global]",  "family": "Anthropic (global)"},
            {"id": "global.anthropic.claude-sonnet-4-20250514-v1:0",    "name": "Claude Sonnet 4 [global]",    "family": "Anthropic (global)"},
            {"id": "global.anthropic.claude-haiku-4-5-20251001-v1:0",   "name": "Claude Haiku 4.5 [global]",   "family": "Anthropic (global)"},
            {"id": "global.amazon.nova-2-lite-v1:0",                     "name": "Nova 2 Lite [global]",        "family": "Amazon Nova (global)"},

            # ── us.* — US regions ────────────────────────────────────────────
            {"id": "us.anthropic.claude-opus-4-6-v1",               "name": "Claude Opus 4.6 [us]",          "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-opus-4-5-20251101-v1:0",    "name": "Claude Opus 4.5 [us]",          "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-opus-4-20250514-v1:0",      "name": "Claude Opus 4 [us]",            "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-opus-4-1-20250805-v1:0",    "name": "Claude Opus 4.1 [us]",          "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-sonnet-4-6",                 "name": "Claude Sonnet 4.6 [us]",        "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-sonnet-4-5-20250929-v1:0",  "name": "Claude Sonnet 4.5 [us]",        "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-sonnet-4-20250514-v1:0",    "name": "Claude Sonnet 4 [us]",          "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-haiku-4-5-20251001-v1:0",   "name": "Claude Haiku 4.5 [us]",         "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-7-sonnet-20250219-v1:0",  "name": "Claude 3.7 Sonnet [us]",        "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-5-sonnet-20241022-v2:0",  "name": "Claude 3.5 Sonnet v2 [us]",     "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-5-sonnet-20240620-v1:0",  "name": "Claude 3.5 Sonnet [us]",        "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-5-haiku-20241022-v1:0",   "name": "Claude 3.5 Haiku [us]",         "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-opus-20240229-v1:0",      "name": "Claude 3 Opus [us]",            "family": "Anthropic (us)"},
            {"id": "us.anthropic.claude-3-haiku-20240307-v1:0",     "name": "Claude 3 Haiku [us]",           "family": "Anthropic (us)"},
            {"id": "us.amazon.nova-premier-v1:0",                    "name": "Nova Premier [us]",             "family": "Amazon Nova (us)"},
            {"id": "us.amazon.nova-pro-v1:0",                        "name": "Nova Pro [us]",                 "family": "Amazon Nova (us)"},
            {"id": "us.amazon.nova-lite-v1:0",                       "name": "Nova Lite [us]",                "family": "Amazon Nova (us)"},
            {"id": "us.amazon.nova-micro-v1:0",                      "name": "Nova Micro [us]",               "family": "Amazon Nova (us)"},
            {"id": "us.amazon.nova-2-lite-v1:0",                     "name": "Nova 2 Lite [us]",              "family": "Amazon Nova (us)"},
            {"id": "us.meta.llama4-maverick-17b-instruct-v1:0",      "name": "Llama 4 Maverick 17B [us]",    "family": "Meta Llama (us)"},
            {"id": "us.meta.llama4-scout-17b-instruct-v1:0",         "name": "Llama 4 Scout 17B [us]",       "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-3-70b-instruct-v1:0",             "name": "Llama 3.3 70B [us]",           "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-2-90b-instruct-v1:0",             "name": "Llama 3.2 90B [us]",           "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-2-11b-instruct-v1:0",             "name": "Llama 3.2 11B [us]",           "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-2-3b-instruct-v1:0",              "name": "Llama 3.2 3B [us]",            "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-2-1b-instruct-v1:0",              "name": "Llama 3.2 1B [us]",            "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-1-405b-instruct-v1:0",            "name": "Llama 3.1 405B [us]",          "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-1-70b-instruct-v1:0",             "name": "Llama 3.1 70B [us]",           "family": "Meta Llama (us)"},
            {"id": "us.meta.llama3-1-8b-instruct-v1:0",              "name": "Llama 3.1 8B [us]",            "family": "Meta Llama (us)"},
            {"id": "us.deepseek.r1-v1:0",                            "name": "DeepSeek R1 [us]",             "family": "DeepSeek (us)"},
            {"id": "us.mistral.pixtral-large-2502-v1:0",             "name": "Pixtral Large 25.02 [us]",     "family": "Mistral (us)"},
            ...
            # ── eu.* — European regions ──────────────────────────────────────
            {"id": "eu.anthropic.claude-opus-4-6-v1",               "name": "Claude Opus 4.6 [eu]",          "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-opus-4-5-20251101-v1:0",    "name": "Claude Opus 4.5 [eu]",          "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-sonnet-4-6",                 "name": "Claude Sonnet 4.6 [eu]",        "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-sonnet-4-5-20250929-v1:0",  "name": "Claude Sonnet 4.5 [eu]",        "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-sonnet-4-20250514-v1:0",    "name": "Claude Sonnet 4 [eu]",          "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-haiku-4-5-20251001-v1:0",   "name": "Claude Haiku 4.5 [eu]",         "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-3-7-sonnet-20250219-v1:0",  "name": "Claude 3.7 Sonnet [eu]",        "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-3-5-sonnet-20240620-v1:0",  "name": "Claude 3.5 Sonnet [eu]",        "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-3-sonnet-20240229-v1:0",    "name": "Claude 3 Sonnet [eu]",          "family": "Anthropic (eu)"},
            {"id": "eu.anthropic.claude-3-haiku-20240307-v1:0",     "name": "Claude 3 Haiku [eu]",           "family": "Anthropic (eu)"},
            {"id": "eu.amazon.nova-pro-v1:0",                        "name": "Nova Pro [eu]",                 "family": "Amazon Nova (eu)"},
            {"id": "eu.amazon.nova-lite-v1:0",                       "name": "Nova Lite [eu]",                "family": "Amazon Nova (eu)"},
            {"id": "eu.amazon.nova-micro-v1:0",                      "name": "Nova Micro [eu]",               "family": "Amazon Nova (eu)"},
            {"id": "eu.amazon.nova-2-lite-v1:0",                     "name": "Nova 2 Lite [eu]",              "family": "Amazon Nova (eu)"},
            {"id": "eu.meta.llama3-2-3b-instruct-v1:0",             "name": "Llama 3.2 3B [eu]",            "family": "Meta Llama (eu)"},
            {"id": "eu.meta.llama3-2-1b-instruct-v1:0",             "name": "Llama 3.2 1B [eu]",            "family": "Meta Llama (eu)"},
            {"id": "eu.mistral.pixtral-large-2502-v1:0",            "name": "Pixtral Large 25.02 [eu]",     "family": "Mistral (eu)"},

            # ── apac.* — Asia-Pacific regions ────────────────────────────────
            {"id": "apac.anthropic.claude-sonnet-4-20250514-v1:0",  "name": "Claude Sonnet 4 [apac]",        "family": "Anthropic (apac)"},
            {"id": "apac.anthropic.claude-3-7-sonnet-20250219-v1:0","name": "Claude 3.7 Sonnet [apac]",      "family": "Anthropic (apac)"},
            {"id": "apac.anthropic.claude-3-5-sonnet-20241022-v2:0","name": "Claude 3.5 Sonnet v2 [apac]",   "family": "Anthropic (apac)"},
            {"id": "apac.anthropic.claude-3-5-sonnet-20240620-v1:0","name": "Claude 3.5 Sonnet [apac]",      "family": "Anthropic (apac)"},
            {"id": "apac.anthropic.claude-3-sonnet-20240229-v1:0",  "name": "Claude 3 Sonnet [apac]",        "family": "Anthropic (apac)"},
            {"id": "apac.anthropic.claude-3-haiku-20240307-v1:0",   "name": "Claude 3 Haiku [apac]",         "family": "Anthropic (apac)"},
            {"id": "apac.amazon.nova-pro-v1:0",                      "name": "Nova Pro [apac]",               "family": "Amazon Nova (apac)"},
            {"id": "apac.amazon.nova-lite-v1:0",                     "name": "Nova Lite [apac]",              "family": "Amazon Nova (apac)"},
            {"id": "apac.amazon.nova-micro-v1:0",                    "name": "Nova Micro [apac]",             "family": "Amazon Nova (apac)"},

            # ── au.* — Australia ──────────────────────────────────────────────
            {"id": "au.anthropic.claude-opus-4-6-v1",              "name": "Claude Opus 4.6 [au]",    "family": "Anthropic (au)"},
            {"id": "au.anthropic.claude-sonnet-4-6",               "name": "Claude Sonnet 4.6 [au]",  "family": "Anthropic (au)"},
            {"id": "au.anthropic.claude-sonnet-4-5-20250929-v1:0", "name": "Claude Sonnet 4.5 [au]",  "family": "Anthropic (au)"},
            {"id": "au.anthropic.claude-haiku-4-5-20251001-v1:0",  "name": "Claude Haiku 4.5 [au]",   "family": "Anthropic (au)"},

            # ── jp.* — Japan ──────────────────────────────────────────────────
            {"id": "jp.anthropic.claude-sonnet-4-6",               "name": "Claude Sonnet 4.6 [jp]",  "family": "Anthropic (jp)"},
            {"id": "jp.anthropic.claude-sonnet-4-5-20250929-v1:0", "name": "Claude Sonnet 4.5 [jp]",  "family": "Anthropic (jp)"},
            {"id": "jp.anthropic.claude-haiku-4-5-20251001-v1:0",  "name": "Claude Haiku 4.5 [jp]",   "family": "Anthropic (jp)"},
            {"id": "jp.amazon.nova-2-lite-v1:0",                    "name": "Nova 2 Lite [jp]",        "family": "Amazon Nova (jp)"},
        ],
    ...
    "vertex_ai": {
        ...
        "models": [
            ...
            {"id": "gemini-2.5-pro",           "name": "Gemini 2.5 Pro (recommended, 1M ctx)",  "family": "Gemini 2.5"},
            {"id": "gemini-2.5-flash",         "name": "Gemini 2.5 Flash (1M ctx)",             "family": "Gemini 2.5"},
            {"id": "gemini-2.5-flash-lite",    "name": "Gemini 2.5 Flash-Lite (1M ctx)",        "family": "Gemini 2.5"},
            # ── Gemini 2.0 series (GA) ────────────────────────────────────────
            {"id": "gemini-2.0-flash",         "name": "Gemini 2.0 Flash (alias, 1M ctx)",      "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-001",     "name": "Gemini 2.0 Flash 001 (pinned)",         "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-lite",    "name": "Gemini 2.0 Flash-Lite (alias, 1M ctx)", "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-lite-001","name": "Gemini 2.0 Flash-Lite 001 (pinned)",    "family": "Gemini 2.0"},
        ],
    },
    "gemini": {
        ...
        "models": [
            ...
            {"id": "gemini-2.5-flash",                  "name": "Gemini 2.5 Flash (1M ctx)",             "family": "Gemini 2.5"},
            {"id": "gemini-2.5-flash-lite",             "name": "Gemini 2.5 Flash-Lite (1M ctx)",        "family": "Gemini 2.5"},
            {"id": "gemini-2.5-pro-preview-05-06",      "name": "Gemini 2.5 Pro Preview (pinned)",       "family": "Gemini 2.5"},
            {"id": "gemini-2.5-flash-preview-05-20",    "name": "Gemini 2.5 Flash Preview (pinned)",     "family": "Gemini 2.5"},
            # ── Gemini 2.0 series (GA) ────────────────────────────────────────
            {"id": "gemini-2.0-flash",                  "name": "Gemini 2.0 Flash (alias, 1M ctx)",      "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-001",              "name": "Gemini 2.0 Flash 001 (pinned)",         "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-lite",             "name": "Gemini 2.0 Flash-Lite (alias, 1M ctx)", "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-lite-001",         "name": "Gemini 2.0 Flash-Lite 001 (pinned)",   "family": "Gemini 2.0"},
            {"id": "gemini-2.0-pro-exp",                "name": "Gemini 2.0 Pro Experimental (2M ctx)",  "family": "Gemini 2.0"},
            {"id": "gemini-2.0-flash-thinking-exp-01-21", "name": "Gemini 2.0 Flash Thinking Exp",      "family": "Gemini 2.0"},
            # ── Gemini 1.5 series (legacy — may still be accessible via Gemini API) ──
            {"id": "gemini-1.5-pro",                    "name": "Gemini 1.5 Pro (legacy, 2M ctx)",       "family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-pro-latest",             "name": "Gemini 1.5 Pro Latest (legacy alias)",  "family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-pro-002",                "name": "Gemini 1.5 Pro 002 (legacy, pinned)",   "family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-flash",                  "name": "Gemini 1.5 Flash (legacy, 1M ctx)",     "family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-flash-latest",           "name": "Gemini 1.5 Flash Latest (legacy alias)","family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-flash-002",              "name": "Gemini 1.5 Flash 002 (legacy, pinned)", "family": "Gemini 1.5 Legacy"},
            {"id": "gemini-1.5-flash-8b",               "name": "Gemini 1.5 Flash-8B (legacy)",          "family": "Gemini 1.5 Legacy"},
        ],
    },
    "azure_ai": {
        "name": "Azure AI",
        ...
        "models": [
            ...
            # ── Meta Llama ────────────────────────────────────────────────────
            {"id": "Llama-4-Maverick-17B-128E-Instruct-FP8", "name": "Llama 4 Maverick 17B (FP8)", "family": "Meta Llama"},
            {"id": "Llama-4-Scout-17B-16E-Instruct",         "name": "Llama 4 Scout 17B",          "family": "Meta Llama"},
            {"id": "Llama-3.3-70B-Instruct",                 "name": "Llama 3.3 70B",              "family": "Meta Llama"},
            {"id": "Meta-Llama-3.1-405B-Instruct",           "name": "Llama 3.1 405B",             "family": "Meta Llama"},
            {"id": "Meta-Llama-3.1-8B-Instruct",             "name": "Llama 3.1 8B",               "family": "Meta Llama"},
            {"id": "Llama-3.2-90B-Vision-Instruct",          "name": "Llama 3.2 90B Vision",       "family": "Meta Llama"},
            {"id": "Llama-3.2-11B-Vision-Instruct",          "name": "Llama 3.2 11B Vision",       "family": "Meta Llama"},
            ...
            {"id": "Phi-4-multimodal-instruct",   "name": "Phi-4 Multimodal",             "family": "Microsoft Phi"},
            {"id": "Phi-4-reasoning",             "name": "Phi-4 Reasoning",              "family": "Microsoft Phi"},
            {"id": "Phi-4-mini-reasoning",        "name": "Phi-4 Mini Reasoning",         "family": "Microsoft Phi"},
            {"id": "MAI-DS-R1",                   "name": "MAI-DS-R1 (reasoning)",        "family": "Microsoft Phi"},
            # ── DeepSeek (hosted by Azure) ────────────────────────────────────
            {"id": "DeepSeek-R1-0528",  "name": "DeepSeek R1 (0528, reasoning)", "family": "DeepSeek"},
            ...
            {"id": "Cohere-command-r-plus-08-2024", "name": "Cohere Command R+ (2024)",   "family": "Cohere"},
            {"id": "Cohere-command-r-08-2024",      "name": "Cohere Command R (2024)",    "family": "Cohere"},
...
def _load_platform_defaults() -> list[dict]:
    ...
    try:
        ...
        raise ValueError(
            f"Invalid TOML in platform config ({config_path}): {exc}"
        ) from exc
    for entry in raw:
...
_SECRET_PROVIDER_HINTS: list[dict] = [
    {"keyword": "anthropic", "provider": "anthropic", "label": "Anthropic Claude",
     "model_id": "claude-sonnet-4-6", "default_temperature": 1.0},
    {"keyword": "openai",    "provider": "openai",    "label": "OpenAI GPT",
     "model_id": "gpt-4.1",           "default_temperature": 1.0},
    {"keyword": "google",    "provider": "gemini",    "label": "Google Gemini",
     "model_id": "gemini-2.5-pro",    "default_temperature": 1.0},
    # azure / bedrock require user-supplied deployment name — model_id left None
    {"keyword": "azure",     "provider": "azure_ai",  "label": "Azure AI (custom deployment)",
     "model_id": None,                "default_temperature": 0.7},
    {"keyword": "bedrock",   "provider": "bedrock",   "label": "AWS Bedrock (custom model)",
     "model_id": None,                "default_temperature": 0.7},
]
...
def resolve_model(provider_id: str, model_input: str) -> dict:
    ...
    if pdata.get("deployment_based"):
        ...
        secret_hint = (
            f"Requires '{pdata['requires_secret']}' secret" if pdata.get("requires_secret")
    ...
    if stripped.isdigit():
        ...
        if not resolved:
            ...
            if len(matches) == 1:
                ...
                raise ValueError(f"Ambiguous model '{stripped}' — matches: {names}. Please be more specific.")
            else:
